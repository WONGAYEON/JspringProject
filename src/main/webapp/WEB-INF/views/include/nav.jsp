  ...
  function kakaoLogout(){
	  ...
	  if(accessToken){
		  Kakao.Auth.logout(function(){
			  window.location.href = "https://kauth.kakao.com/oauth/logout?client_id=57e3b7cb89fef6596fd4af0a6896e9a8&logout_redirect_uri=http://localhost:9090/JspringProject/member/memberLogout";
		  });
	  }
  }
</script>
