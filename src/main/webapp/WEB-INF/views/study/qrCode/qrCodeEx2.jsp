...
<div class="container">
		...
		<div>(소개하고 싶은 사이트의 주소를 아래에 입력해 주세요: 예) 고궁, 박물관(전시)-그림, 문화재, 블로그, 홈페이지, 상품상세설명, 쿠폰상세설명사이트 등등)</div>
		<form name="myform" method="post">
				<table class="table table-bordered text-center">
						<tr>
								<th>이동 할 주소</th>
								<td><input type="text" name="moveUrl" id="moveUrl" value="www.naver.com" autofocus required class="form-control" /></td>
						</tr>
						<tr>
								<td colspan="2">
