    ...
    <tr>
      ...
      <td>
		...
		<div class="input-group">
				<input type="text" name="pwd" id="pwd" value="abcd1234!@#$" autofocus class="form-control"/>
				<input type="button" value="다시하기" onclick="location.reload()" class="btn btn-warning">
		</div>
		<hr class="border-secondary">
		<div>
				<input type="button" value="sha256" onclick="sha256Check()" class="btn btn-success me-2" />
				<input type="button" value="BCryptPasswordCheck" onclick="bCryptPasswordCheck()" class="btn btn-primary me-2" />
