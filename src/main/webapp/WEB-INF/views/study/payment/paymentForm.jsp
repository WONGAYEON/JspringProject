...
<div class="container">
  ...
  <form name="myform" method="post">
    ...
    <table class="table table-bordered">
      ...
      <tr>
	      <th>이메일</th>
	      <td><input type="text" name="buyer_email" value="dnjsrkdus0403@naver.com" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주문자</th>
	      <td><input type="text" name="buyer_name" value="원가연" class="form-control"/></td>
      </tr>
      <tr>
	      <th>연락처</th>
	      <td><input type="text" name="buyer_tel" value="010-9800-6697" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주소</th>
