...
<div class="container">
	<form method="post">
  		...
  		<tr>
  			<th>주소</th>
  			<td><input type="text" name="address" id="address" value="${vo.address}" class="form-control" />
  			</td>
  		</tr>
  		<tr>
  			<td colspan="2">
  				...
  				<input type="button" value="돌아가기" onclick="location.href='${ctp}/user/userList';" class="btn btn-primary" />
  		</tr>
  	</table>	
