...
select avg(star) from review where part='pds' and partIdx=19;
select * from (select * from review where part='pds' and partIdx=19) as v left join reviewReply r 
    on v.partIdx=19 and v.idx=r.reviewIdx order by v.idx desc, r.replyIdx desc;
